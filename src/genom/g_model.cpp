...
namespace std {
    template<>
    struct hash<genom::GModel::Vertex> {
        size_t operator()(genom::GModel::Vertex const &vertex) const {
            size_t seed = 0;
...
namespace genom {
    GModel::GModel(GDevice &device, const GModel::Builder &builder) : gDevice{device} {
